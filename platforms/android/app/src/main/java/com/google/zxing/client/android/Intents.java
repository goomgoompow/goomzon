...
public final class Intents {
  ...
  /**
   * AppConstants related to the {@link Scan#ACTION} Intent.
   */
  ...
  /**
   * AppConstants related to the scan history and retrieving history items.
   */
  ...
  /**
   * AppConstants related to the {@link Encode#ACTION} Intent.
   */
  ...
  /**
   * AppConstants related to the {@link SearchBookContents#ACTION} Intent.
   */
  ...
  /**
   * AppConstants related to the {@link WifiConnect#ACTION} Intent.
   */
  ...
  /**
   * AppConstants related to the {@link Share#ACTION} Intent.
   */
